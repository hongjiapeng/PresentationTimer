...
using SlidePace.Remote.Networking;
using RemoteHost = SlidePace.Remote.RemoteSessionHost;

namespace SlidePace.Remote.Tests.Security;
...
public sealed class NetworkAddressProviderTests
{
    ...
    public void CreatePairingDescriptor_MultipleAdapters_MapsLabelsAndExactUris()
    {
        ...
        // Act
        SlidePace.Core.Models.DesktopPairingDescriptor descriptor =
        ...
        foreach (SlidePace.Core.Models.DesktopPairingCandidate candidate in descriptor.Candidates)
        {
