...
- Add read-only observation and next/previous control of the currently running Microsoft PowerPoint presentation and slide show, including slide position and current speaker notes.
...
- `powerpoint-control`: Detection, observation, notes retrieval, navigation, event-driven synchronization, and graceful loss/recovery of a running PowerPoint slide show.
...
- Reads and controls the user's currently running PowerPoint slide show without editing or owning the presentation file, and must release all COM subscriptions and references on disconnect or shutdown.
